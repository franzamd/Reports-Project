...
const UpdateRoadmap = props => {
    ...
    const { error, loading, getRoadmap, updateRoadmap, resetRoadmaps } = roadmapContext;
    ...
    useEffect(() => {
        if (
            ...
            roadmapContext.roadmap.data
        ) {
            roadmapContext.roadmap.data.begin = roadmapContext.roadmap.data.begin.slice(0, 10)
            roadmapContext.roadmap.data.finish = roadmapContext.roadmap.data.finish.slice(0, 10)
    ...
    const getManagersArray = (businessId) => {
        ...
        console.log(businessContext.business)
